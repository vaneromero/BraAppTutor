...
class recomendar : Fragment() {
    var soundPool: SoundPool? = null
    override fun onCreateView(
        inflater: LayoutInflater, container: ViewGroup?,
        savedInstanceState: Bundle?
    ): View? {
        val view = inflater.inflate(R.layout.activity_recomendar, container, false)

        val title: LottieAnimationView = view.findViewById(R.id.Avaz1)
