package com.bp.braapptutor.catalogo
...
import kotlinx.android.synthetic.main.activity_propio.*
import kotlinx.android.synthetic.main.activity_propio.view.*
import kotlinx.android.synthetic.main.activity_red.*
import kotlinx.android.synthetic.main.nav_header_main.*
import kotlinx.android.synthetic.main.nav_header_main.view.*
import java.io.IOException

class MenuCatalogo : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_menu_catalogo)
        checkNetworkConnection()
        mAuth = FirebaseAuth.getInstance()
        val texto1: LinearLayout = findViewById(R.id.jdjd)
        ...
        setSupportActionBar(findViewById(R.id.toolbarMC1))
        navigation_viewMC1.addOnLayoutChangeListener { view, i, i2, i3, i4, i5, i6, i7, i8 ->
            val Archivo = "Usuario"
            val defaultPrefs = Splash.PreferenceHelper.defaultPreference(this)
            defaultPrefs.password = "Admin"
            defaultPrefs.userId = 0
            ...
            view.NaveCloo.setOnClickListener {
                ...
                if (prefs2.entrada == 0) {
                    ...
                    customDialog.dlv.setOnClickListener {
                        ...
                        prefs2.entrada = 0
                        finish()
                        startActivity(Intent(this@MenuCatalogo, Usuarios::class.java))
                        Bungee.zoom(this)
        ...
        navigation_viewMC1.setNavigationItemSelectedListener {
            val Archivo1 = "Audio"
            val defaultPrefs1 = Splash.PreferenceHelper1.defaultPreference1(this)
            defaultPrefs1.tono = 1
            defaultPrefs1.melodia = 1
            ...
            when (it.itemId) {
                R.id.uno1 -> {
                    drawerMC1.closeDrawer(GravityCompat.START)
                    soundPool!!.play(carga, prefs1.volum1, prefs1.volum1, 0, 0, 1f)
        ...
        val drawerToggle = ActionBarDrawerToggle(this, drawerMC1, R.string.open, R.string.close)
        drawerMC1.addDrawerListener(drawerToggle)
        drawerToggle.drawerArrowDrawable.color = Color.BLACK
        drawerToggle.drawerArrowDrawable.gapSize = 30.0f
        drawerToggle.syncState()
        supportActionBar?.setDisplayHomeAsUpEnabled(true)
        navigation_viewMC1.itemIconTintList = null
        navBottomNavigationView.itemIconTintList = null
        ...
        bu23f.text = prefs.password
        val foto2 = prefs.userId.toString()
        when {
            foto2.toInt() == 0 -> {
                fotito121.setBackgroundResource(R.drawable.nina)
            }
            foto2.toInt() == 1 -> {
                fotito121.setBackgroundResource(R.drawable.nino)
            }
            foto2.toInt() == 2 -> {
                fotito121.setBackgroundResource(R.drawable.jovena)
            }
            foto2.toInt() == 3 -> {
                fotito121.setBackgroundResource(R.drawable.joveno)
            }
            foto2.toInt() == 4 -> {
                fotito121.setBackgroundResource(R.drawable.adulta)
            }
            foto2.toInt() == 5 -> {
                fotito121.setBackgroundResource(R.drawable.adulto)
            }
            foto2.toInt() == 6 -> {
                fotito121.setBackgroundResource(R.drawable.abuelo)
            }
            foto2.toInt() == 7 -> {
                fotito121.setBackgroundResource(R.drawable.abuela)
            }
            foto2.toInt() == 8 -> {
                fotito121.setBackgroundResource(R.drawable.indefinido)
            }
        }
    ...
    private fun checkNetworkConnection() {
        ...
        connectivityLiveData.observe(this, Observer { isAvailable ->
            when (isAvailable) {
                ...
                true -> {
                    wiffaa1.setBackgroundResource(R.drawable.wific)
                }
                false -> {
                    wiffaa1.setBackgroundResource(R.drawable.wifis)
    ...
    override fun onBackPressed() {
        if (drawerMC1.isDrawerOpen(GravityCompat.START)) {
            drawerMC1.closeDrawer(GravityCompat.START)
        } else {
            super.onBackPressed()
            startActivity(Intent(this@MenuCatalogo, MenuPrin::class.java))
            Bungee.zoom(this)
            finish()
        }
    }
    ...
    override fun onOptionsItemSelected(item: MenuItem): Boolean {
        ...
        return when (item.itemId) {
            android.R.id.home -> {
                drawerMC1.openDrawer(GravityCompat.START)
                true
            }
