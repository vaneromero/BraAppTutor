...
class BraesMin : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_braes_min)
        getWindow().setSoftInputMode(WindowManager.LayoutParams.SOFT_INPUT_ADJUST_PAN)
        val texto2: LinearLayout = findViewById(R.id.drawerT11)
        ...
        btnuno.setOnClickListener {
            ...
            if (noUno == 1) {
                noUno = 1
                btnuno.setBackgroundDrawable(resources.getDrawable(R.drawable.on1))

            } else {
                noUno = 0
                btnuno.setBackgroundDrawable(resources.getDrawable(R.drawable.off1))
            }
        }
        btndos.setOnClickListener {
            ...
            if (noDos == 1) {
                noDos = 1
                btndos.setBackgroundDrawable(resources.getDrawable(R.drawable.on1))
            } else {
                noDos = 0
                btndos.setBackgroundDrawable(resources.getDrawable(R.drawable.off1))
            }
        }
        btntres.setOnClickListener {
            ...
            if (noTres == 1) {
                noTres = 1
                btntres.setBackgroundDrawable(resources.getDrawable(R.drawable.on1))
            } else {
                noTres = 0
                btntres.setBackgroundDrawable(resources.getDrawable(R.drawable.off1))
            }
        }
        btncuatro.setOnClickListener {
            ...
            if (noCuatro == 1) {
                noCuatro = 1
                btncuatro.setBackgroundDrawable(resources.getDrawable(R.drawable.on1))
            } else {
                noCuatro = 0
                btncuatro.setBackgroundDrawable(resources.getDrawable(R.drawable.off1))
            }
        }
        btncinco.setOnClickListener {
            ...
            if (noCinco == 1) {
                noCinco = 1
                btncinco.setBackgroundDrawable(resources.getDrawable(R.drawable.on1))
            } else {
                noCinco = 0
                btncinco.setBackgroundDrawable(resources.getDrawable(R.drawable.off1))
            }
        }
        btnseis.setOnClickListener {
            ...
            if (noSeis == 1) {
                noSeis = 1
                btnseis.setBackgroundDrawable(resources.getDrawable(R.drawable.on1))
            } else {
                noSeis = 0
                btnseis.setBackgroundDrawable(resources.getDrawable(R.drawable.off1))
            }
        }
        ...
        setSupportActionBar(findViewById(R.id.toolbarT5))
        navigation_viewT5.addOnLayoutChangeListener { view, i, i2, i3, i4, i5, i6, i7, i8 ->
            ...
            view.NaveCloo.setOnClickListener {
                ...
                if (prefs2.entrada == 0) {
                    ...
                    customDialog.dlv.setOnClickListener {
                        ...
                        prefs2.entrada = 0
                        finish()
                        startActivity(Intent(this@BraesMin, Usuarios::class.java))
                        Bungee.zoom(this)
        ...
        navigation_viewT5.setNavigationItemSelectedListener {
            val Archivo1 = "Audio"
            val defaultPrefs1 = Splash.PreferenceHelper1.defaultPreference1(this)
            defaultPrefs1.tono = 1
            defaultPrefs1.melodia = 1
            ...
            when (it.itemId) {
                R.id.uno1 -> {
                    drawerT5.closeDrawer(GravityCompat.START)
                    soundPool!!.play(carga, prefs1.volum1, prefs1.volum1, 0, 0, 1f)
        ...
        val drawerToggle = ActionBarDrawerToggle(this, drawerT5, R.string.open, R.string.close)
        drawerT5.addDrawerListener(drawerToggle)
        drawerToggle.drawerArrowDrawable.color = Color.BLACK
        drawerToggle.drawerArrowDrawable.gapSize = 30.0f
        drawerToggle.syncState()
        supportActionBar?.setDisplayHomeAsUpEnabled(true)
        navigation_viewT5.setItemIconTintList(null);
    }
    ...
    override fun onBackPressed() {
        if (drawerT5.isDrawerOpen(GravityCompat.START)) {
            drawerT5.closeDrawer(GravityCompat.START)
        } else {
            super.onBackPressed()
        }
    ...
    override fun onOptionsItemSelected(item: MenuItem): Boolean {
        ...
        return when (item.itemId) {
            android.R.id.home -> {
                drawerT5.openDrawer(GravityCompat.START)
                true
            }
