...
import kotlinx.android.synthetic.main.activity_memonum.*
import kotlinx.android.synthetic.main.activity_memonum.puntaje
import kotlinx.android.synthetic.main.activity_memonum.reintentar
import kotlinx.android.synthetic.main.activity_memonum.vida
...
class memosim : AppCompatActivity() {
    var marcador: Int = 0
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_memosim)
        val Archivo = "Usuario"
        ...
        val texto2: LinearLayout = findViewById(R.id.memosim1)
        ...
        when {
            fotom.toInt() == 0 -> {
                fotom4.setBackgroundResource(R.drawable.nina)
            }
            fotom.toInt() == 1 -> {
                fotom4.setBackgroundResource(R.drawable.nino)
            }
            fotom.toInt() == 2 -> {
                fotom4.setBackgroundResource(R.drawable.jovena)
            }
            fotom.toInt() == 3 -> {
                fotom4.setBackgroundResource(R.drawable.joveno)
            }
            fotom.toInt() == 4 -> {
                fotom4.setBackgroundResource(R.drawable.adulta)
            }
            fotom.toInt() == 5 -> {
                fotom4.setBackgroundResource(R.drawable.adulto)
            }
            fotom.toInt() == 6 -> {
                fotom4.setBackgroundResource(R.drawable.abuelo)
            }
            fotom.toInt() == 7 -> {
                fotom4.setBackgroundResource(R.drawable.abuela)
            }
            fotom.toInt() == 8 -> {
                fotom4.setBackgroundResource(R.drawable.indefinido)
            }
        }
        ...
        setSupportActionBar(findViewById(R.id.toolbarJ14))
        navigation_viewJ14.addOnLayoutChangeListener { view, i, i2, i3, i4, i5, i6, i7, i8 ->
            ...
            view.NaveCloo.setOnClickListener {
                ...
                if (prefs2.entrada == 0) {
                    ...
                    customDialog.dlv.setOnClickListener {
                        ...
                        prefs2.entrada = 0
                        finish()
                        startActivity(Intent(this@memosim, Usuarios::class.java))
                        Bungee.zoom(this)
        ...
        navigation_viewJ14.setNavigationItemSelectedListener {
            val Archivo1 = "Audio"
            ...
            when (it.itemId) {
                R.id.uno1 -> {
                    drawerJ14.closeDrawer(GravityCompat.START)
                    soundPool!!.play(carga, prefs1.volum1, prefs1.volum1, 0, 0, 1f)
        ...
        val drawerToggle = ActionBarDrawerToggle(this, drawerJ14, R.string.open, R.string.close)
        drawerJ14.addDrawerListener(drawerToggle)
        drawerToggle.drawerArrowDrawable.color = Color.BLACK
        drawerToggle.drawerArrowDrawable.gapSize = 30.0f
        drawerToggle.syncState()
        supportActionBar?.setDisplayHomeAsUpEnabled(true)
        navigation_viewJ14.setItemIconTintList(null);
        val CUSTOM_PREF_NAME = "Record"
        val defaultPrefs = MenuJuegos.PreferenceHelper.defaultPreference(this)
        defaultPrefs.contadorE = 0
        defaultPrefs.contadorV = 0
    ...
    private fun asignarImagenalaCarta(image: ImageView, carta: Int) {
        if (vidas >= 1) {
            ...
            var dato2 = "Te has quedado sin vidas"
    ...
    fun mensaje(dato: String) {
        var dato1 = ""
        if (dato.equals("arroba")) {
            dato1 = "@"
        } else if (dato.equals("asterisco")) {
            dato1 = "*"
        } else if (dato.equals("barra_vertical")) {
            dato1 = "|"
        } else if (dato.equals("coma")) {
            dato1 = ","
        } else if (dato.equals("corchete_abrir")) {
            dato1 = "{"
        } else if (dato.equals("corchete_cerrar")) {
            dato1 = "}"
        } else if (dato.equals("diagonal")) {
            dato1 = "/"
        } else if (dato.equals("dividir")) {
            dato1 = "÷"
        } else if (dato.equals("doble_flecha")) {
            dato1 = "»"
        } else if (dato.equals("dos_puntos")) {
            dato1 = ":"
        } else if (dato.equals("exponencial")) {
            dato1 = "^"
        } else if (dato.equals("guion_bajo")) {
            dato1 = "_"
        } else if (dato.equals("igual")) {
            dato1 = "="
        } else if (dato.equals("multiplicar")) {
            dato1 = "x"
        } else if (dato.equals("numeros")) {
            dato1 = "#"
        } else if (dato.equals("parentesis_cerrar")) {
            dato1 = ")"
        } else if (dato.equals("parentesis_abrir")) {
            dato1 = "("
        } else if (dato.equals("punto")) {
            dato1 = "."
        } else if (dato.equals("punto_coma")) {
            dato1 = ";"
        } else if (dato.equals("resta")) {
            dato1 = "-"
        } else if (dato.equals("signos_admiracion")) {
            dato1 = "¡!"
        } else if (dato.equals("signos_interrogacion")) {
            dato1 = "¿?"
        } else if (dato.equals("simbolo_c")) {
            dato1 = "Ç"
        } else if (dato.equals("suma")) {
            dato1 = "+"
        }
        val customDialog = Dialog(this)
        ...
        customDialog.imageee1.visibility = View.VISIBLE
        customDialog.imageee.visibility = View.GONE
        customDialog.letraa.text = "$dato1"
        customDialog.imageee1.setBackgroundResource(
            getResources().getIdentifier(
                dato,
                "drawable",
                getPackageName()
    ...
    override fun onBackPressed() {
        if (drawerJ14.isDrawerOpen(GravityCompat.START)) {
            drawerJ14.closeDrawer(GravityCompat.START)
        } else {
            super.onBackPressed()
            startActivity(Intent(this, MenuJuegos::class.java))
    ...
    override fun onOptionsItemSelected(item: MenuItem): Boolean {
        ...
        return when (item.itemId) {
            android.R.id.home -> {
                drawerJ14.openDrawer(GravityCompat.START)
                true
            }
