...
import kotlinx.android.synthetic.main.activity_creditoss.imagen
...
class memomin : AppCompatActivity() {
    var marcador: Int = 0
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_memomin)
        val texto2: LinearLayout = findViewById(R.id.memomin1)
        ...
        userm1.text = namem1
        if (fotom.toInt() == 0) {
            fotom1.setBackgroundResource(R.drawable.nina)
        } else if (fotom.toInt() == 1) {
            fotom1.setBackgroundResource(R.drawable.nino)
        } else if (fotom.toInt() == 2) {
            fotom1.setBackgroundResource(R.drawable.jovena)
        } else if (fotom.toInt() == 3) {
            fotom1.setBackgroundResource(R.drawable.joveno)
        } else if (fotom.toInt() == 4) {
            fotom1.setBackgroundResource(R.drawable.adulta)
        } else if (fotom.toInt() == 5) {
            fotom1.setBackgroundResource(R.drawable.adulto)
        } else if (fotom.toInt() == 6) {
            fotom1.setBackgroundResource(R.drawable.abuelo)
        } else if (fotom.toInt() == 7) {
            fotom1.setBackgroundResource(R.drawable.abuela)
        } else if (fotom.toInt() == 8) {
            fotom1.setBackgroundResource(R.drawable.indefinido)
        }
        when (prefs2.tono) {
            1 -> {
        ...
        setUpOnClickListner()
        setSupportActionBar(findViewById(R.id.toolbarJ11))
        navigation_viewJ11.addOnLayoutChangeListener { view, i, i2, i3, i4, i5, i6, i7, i8 ->
            ...
            view.NaveCloo.setOnClickListener {
                ...
                if (prefs2.entrada == 0) {
                    ...
                    customDialog.dlv.setOnClickListener {
                        ...
                        prefs2.entrada = 0
                        finish()
                        startActivity(Intent(this@memomin, Usuarios::class.java))
                        Bungee.zoom(this)
        ...
        navigation_viewJ11.setNavigationItemSelectedListener {
            val Archivo1 = "Audio"
            ...
            when (it.itemId) {
                R.id.uno1 -> {
                    drawerJ11.closeDrawer(GravityCompat.START)
                    soundPool!!.play(carga, prefs1.volum1, prefs1.volum1, 0, 0, 1f)
        ...
        val drawerToggle = ActionBarDrawerToggle(this, drawerJ11, R.string.open, R.string.close)
        drawerJ11.addDrawerListener(drawerToggle)
        drawerToggle.drawerArrowDrawable.color = Color.BLACK
        drawerToggle.drawerArrowDrawable.gapSize = 30.0f
        drawerToggle.syncState()
        supportActionBar?.setDisplayHomeAsUpEnabled(true)
        navigation_viewJ11.setItemIconTintList(null);
    ...
    override fun onBackPressed() {
        if (drawerJ11.isDrawerOpen(GravityCompat.START)) {
            drawerJ11.closeDrawer(GravityCompat.START)
        } else {
            super.onBackPressed()
            startActivity(Intent(this, MenuJuegos::class.java))
    ...
    override fun onOptionsItemSelected(item: MenuItem): Boolean {
        ...
        return when (item.itemId) {
            android.R.id.home -> {
                drawerJ11.openDrawer(GravityCompat.START)
                true
            }
