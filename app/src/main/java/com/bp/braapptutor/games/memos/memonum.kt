...
import kotlinx.android.synthetic.main.activity_memomay.puntaje
import kotlinx.android.synthetic.main.activity_memomay.reintentar
import kotlinx.android.synthetic.main.activity_memomay.vida
...
class memonum : AppCompatActivity() {
    var marcador: Int = 0;
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_memonum)
        val texto2: LinearLayout = findViewById(R.id.memonum1)
        ...
        userm3.text = namem1
        if (fotom.toInt() == 0) {
            fotom3.setBackgroundResource(R.drawable.nina)
        }
        else if (fotom.toInt() == 1) {
            fotom3.setBackgroundResource(R.drawable.nino)
        }
        else if (fotom.toInt() == 2) {
            fotom3.setBackgroundResource(R.drawable.jovena)
        } else if (fotom.toInt() == 3) {
            fotom3.setBackgroundResource(R.drawable.joveno)
        } else if (fotom.toInt() == 4) {
            fotom3.setBackgroundResource(R.drawable.adulta)
        } else if (fotom.toInt() == 5) {
            fotom3.setBackgroundResource(R.drawable.adulto)
        } else if (fotom.toInt() == 6) {
            fotom3.setBackgroundResource(R.drawable.abuelo)
        } else if (fotom.toInt() == 7) {
            fotom3.setBackgroundResource(R.drawable.abuela)
        } else if (fotom.toInt() == 8) {
            fotom3.setBackgroundResource(R.drawable.indefinido)
        }
        ...
        setSupportActionBar(findViewById(R.id.toolbarJ13))
        navigation_viewJ13.addOnLayoutChangeListener { view, i, i2, i3, i4, i5, i6, i7, i8 ->
            ...
            view.NaveCloo.setOnClickListener {
                ...
                if (prefs2.entrada == 0) {
                    ...
                    customDialog.dlv.setOnClickListener {
                        ...
                        prefs2.entrada = 0
                        finish()
                        startActivity(Intent(this@memonum, Usuarios::class.java))
                        Bungee.zoom(this)
        ...
        navigation_viewJ13.setNavigationItemSelectedListener {
            val Archivo1 = "Audio"
            ...
            when (it.itemId) {
                R.id.uno1 -> {
                    drawerJ13.closeDrawer(GravityCompat.START)
        ...
        val drawerToggle = ActionBarDrawerToggle(this, drawerJ13, R.string.open, R.string.close)
        drawerJ13.addDrawerListener(drawerToggle)
        drawerToggle.drawerArrowDrawable.color = Color.BLACK
        drawerToggle.drawerArrowDrawable.gapSize = 30.0f
        drawerToggle.syncState()
        supportActionBar?.setDisplayHomeAsUpEnabled(true)
        navigation_viewJ13.setItemIconTintList(null);
        val CUSTOM_PREF_NAME = "Record"
        val defaultPrefs = MenuJuegos.PreferenceHelper.defaultPreference(this)
        defaultPrefs.contadorE = 0
        defaultPrefs.contadorV = 0
    ...
    fun mensaje(dato: String) {
        ...
        if (dato.equals("num0")) {
            dato1 = "0"
        } else if (dato.equals("num1")) {
            dato1 = "1"
        } else if (dato.equals("num2")) {
            dato1 = "2"
        } else if (dato.equals("num3")) {
            dato1 = "3"
        } else if (dato.equals("num4")) {
            dato1 = "4"
        } else if (dato.equals("num5")) {
            dato1 = "5"
        } else if (dato.equals("num6")) {
            dato1 = "6"
        } else if (dato.equals("num7")) {
            dato1 = "7"
        } else if (dato.equals("num8")) {
            dato1 = "8"
        } else if (dato.equals("num9")) {
            dato1 = "9"
        }
    ...
    override fun onBackPressed() {
        if (drawerJ13.isDrawerOpen(GravityCompat.START)) {
            drawerJ13.closeDrawer(GravityCompat.START)
        } else {
            super.onBackPressed()
            startActivity(Intent(this, MenuJuegos::class.java))
    ...
    override fun onOptionsItemSelected(item: MenuItem): Boolean {
        ...
        return when (item.itemId) {
            android.R.id.home -> {
                drawerJ13.openDrawer(GravityCompat.START)
                true
            }
